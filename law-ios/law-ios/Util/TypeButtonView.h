...
@protocol TypeButtonActionDelegate <NSObject>
...
@interface TypeButtonView : UIView
//@property(nonatomic,assign) JDragonTypeButtonEnum  buttonEnum;
@property(nonatomic,assign) id<TypeButtonActionDelegate> delegate;
 ...
 */
-(void)setTypeButtonTitles:(NSArray*)titles  withDownLableHeight:(CGFloat)downLabHeight andDeleagte:(id<TypeButtonActionDelegate>)deleget;
